...
#                                                       'equipment': (1, equipments['Drill Rig'])})
    """
    3rd Level - Define the feasibility functions
    """

    logPhase_install['F_driven'].op_ve_feasibilty[1].ve_combination[1].feasibility[1] = DefFeasibility(1, 'Equipment_feasiblity')
    logPhase_install['F_driven'].op_ve_feasibilty[1].ve_combination[1].feasibility[2] = DefFeasibility(1, 'Vessel_feasiblity')

    logPhase_install['F_driven'].op_ve_feasibilty[1].ve_combination[1].feasiblity[1].ves_fea[1] = {'sleeve_diam': max(for dev in range(wp2_BoM['numUnits'].ix[0]):
#                for x in range(wp4_BoM['quantity'].ix[0]):
#                    key1 = "diameter foundation " + str(x) + " [m]"
#                    key2 = "length foundation " + str(x) + " [m]"
#                    key3 = "weight foundation " + str(x) + " [kg]"
