...
@author: BTeillant
"""
from wp5.feasibility import wp1_feas
# wp3_feas, wp4_feas

def glob_feas(install, log_phase_id, user_inputs, wp2_outputs, wp3_outputs, wp4_outputs):
    if log_phase_id == 100 or 101 or 102:
        ...
        feasibility = wp4_feas(install, log_phase_id, wp4_outputs)
