...
def electrical_feas(log_phase, log_phase_id, user_inputs):
    """wp3_feas is a function which determines the logistic requirement associated 
    with one logistic phase dealing with the installation of the electrical
    infrastructure
